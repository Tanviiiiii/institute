...
$query = "SELECT * FROM classlink WHERE id = $id";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE classlink SET  class = '$class', subject = '$subject' , chapter = '$chapter', link = '$link' WHERE id = $id";
...
<body>
    <form method="POST">
        ...
        <a href="show-classlink.php" class="btn btn-dark">SHOW TABLE</a>
    </form>
