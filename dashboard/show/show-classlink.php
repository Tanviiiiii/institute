                ...
                <tbody>
                    <?php while ($row = $res->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="update-classlink.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
                            </td>
                            <td>
                                <a href="delete-classlink.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
