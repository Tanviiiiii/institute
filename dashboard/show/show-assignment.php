...
">
        ...
        <div class="container position-relative" style="top: -36%;">
            <h1 class="text-center p-3 text-white">Show Assignment</h1>
                ...
                <tbody>
                    <?php while ($row = $res->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="update-assignment.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>
                            </td>
                            <td>
                                <a href="delete-assignment.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
