...
$query = "SELECT * FROM studymaterial WHERE id = $id";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE studymaterial SET  class = '$class', subject = '$subject' , chapter = '$chapter', concat = '$concat' WHERE id = $id";
...
<body>
    <form method="POST">
        ...
        <a href="show-study.php" class="btn btn-dark">SHOW TABLE</a>
    </form>
