...
<figure style="display: flex;justify-content: center;align-items:center;border-radius: 50%;">
<img src="./assets/img/logo.jpeg" alt="logo" width="100" height="100" style="border-radius: 50%;"></figure>
...
<input type="submit" class="btn-block btn-color text-decoration-none text-center text-white" name="submit" value="Login to s2c" />
 ...
 <!--HEAD:s2c_website/login.php-->
<div class="row d-flex justify-content-center my-2">
<a href="#" class="text-center"><small class="text-muted">Forgot Password?</small></a>
</div>
</div>
</div>
<div class="bottom text-center mb-5">
<p href="#" class="sm-text mx-auto mb-3">If you don't have an account?</p>
<a href="reg.php" class="btn btn-white ml-2">Create your Account</a>
</div>
</div>
</form>
